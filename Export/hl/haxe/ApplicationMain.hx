...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FootNote", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("FootNote", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FootNote";
		app.meta["name"] = "FootNote";
		app.meta["packageName"] = "com.sample.footnote";
